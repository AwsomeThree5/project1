...
opts.expDir = fullfile(vl_rootnnPath, 'data', 'fish-cnn-stage5') ;
[opts, varargin] = vl_argparse(opts, varargin) ;

opts.dataDir = fullfile(vl_rootnn, 'data','fish') ;
opts.imdbPath = fullfile(opts.expDir, 'imdb.mat');
opts.finalDataPath = fullfile(opts.expDir, 'finalDataNormalized.h5');
...
if exist(opts.imdbPath, 'file')
    ...
    imdb = imdb.imdb;
    imdb.images.data = h5read(opts.finalDataPath, ['/',opts.expDir]);
...
net.meta.classes.name = {'fish', 'NoFish'};
