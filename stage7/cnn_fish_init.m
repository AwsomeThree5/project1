function net = cnn_fish_init(varargin)
...
switch opts.model
  ...
  case 'vgg-vd-19'
    ...
    bs = 24 ;
  case 'fishNet'
    net = net_init3(224,224,3) ;
    net.meta.normalization.imageSize = [224, 224, 3] ;
    bs = net.meta.trainOpts.batchSize ;
  case 'fishNet2'
    net = net_init2(224,224,3) ;
    net.meta.normalization.imageSize = [224, 224, 3] ;
    bs = net.meta.trainOpts.batchSize ;
  otherwise
...
% Meta parameters
net.meta.inputSize = [net.meta.normalization.imageSize, 3] ;
